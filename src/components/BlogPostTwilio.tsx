...
const BlogPostTwilio = () => {
  ...
  const steps = [
    {
      ...
      details: [
        "Visit https://www.twilio.com and click 'Sign up for free'",
        "Enter your email, password, and phone number",
        "Verify your phone number via SMS",
        "Complete your account setup",
        "You'll receive a free trial with $15-20 credit"
      ]
    },
    {
      id: 2,
      title: "Get Your Account Credentials",
      description: "Find your Account SID and Auth Token",
      details: [
        "Log into your Twilio Console",
        "Go to the Dashboard",
        "Copy your Account SID (starts with 'AC')",
        "Copy your Auth Token (click 'Show' to reveal)",
        "Keep these credentials secure - you'll need them for API calls"
      ]
    },
    {
      id: 3,
      title: "Get a Phone Number",
      description: "Purchase a Twilio phone number for SMS/voice",
      details: [
        "In the Console, go to 'Phone Numbers' → 'Manage' → 'Buy a number'",
        "Search for available numbers in your desired area code",
        "Select a number with SMS and/or Voice capabilities",
    ...
    {
      id: 4,
      title: "Enable WhatsApp Sandbox (Optional)",
      description: "Set up WhatsApp messaging for testing",
      details: [
        "Go to 'Messaging' → 'Try it out' → 'Send a WhatsApp message'",
        "Follow the instructions to join the sandbox",
        "Send the provided code to the Twilio WhatsApp number",
        "Your WhatsApp number is now connected to the sandbox",
        "You can send messages to other sandbox participants"
      ]
    }
  ];
  ...
  const importantNotes = [
    ...
    "Account SID and Auth Token are sensitive - keep them secure",
    "WhatsApp sandbox is for testing only - limited to sandbox participants",
    "For production WhatsApp, you need to apply for Business API access",
    "Phone numbers are region-specific and may have different capabilities"
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 relative z-10">
        ...
        >
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Learn how to set up your Twilio account, get your SID and auth token, and enable WhatsApp/SMS sandbox for messaging automation with AutomateHQ.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-700 mb-6">
            Now that you have your Twilio credentials, you can use them in AutomateHQ to:
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Send SMS</h4>
              <p className="text-gray-600 text-sm">Automatically send text messages</p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">WhatsApp Messages</h4>
              <p className="text-gray-600 text-sm">Send WhatsApp messages via sandbox</p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Voice Calls</h4>
              <p className="text-gray-600 text-sm">Make automated phone calls</p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Message Tracking</h4>
              <p className="text-gray-600 text-sm">Monitor delivery status and responses</p>
            </div>
          </div>
        </motion.div>
      </div>
