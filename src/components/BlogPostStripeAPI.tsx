...
const BlogPostStripeAPI = () => {
  ...
  const steps = [
    {
      ...
      description: "Access your Stripe account to get your API keys",
      details: [
    ...
    },
    {
      ...
      description: "Copy the keys for use in AutomateHQ",
      details: [
        "Publishable key starts with 'pk_'",
        "Secret key starts with 'sk_'",
        "Click 'Reveal live key token' to see the secret key",
        "Copy and store these keys securely - never share your secret key"
      ]
    },
    {
      id: 3,
      title: "Test Your Keys in Test Mode",
      description: "Use test keys for development and testing",
      details: [
        "Toggle 'View test data' in the dashboard for test keys",
        "Test keys start with 'pk_test_' and 'sk_test_'",
        "Use these keys for development and staging environments",
  ...
  const importantNotes = [
    ...
    "Test keys are safe for development, live keys for production only",
    "You can roll and regenerate keys anytime in the dashboard",
    "Monitor API usage and errors in Stripe dashboard",
    "Keep your keys secure to prevent unauthorized access"
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 relative z-10">
        ...
        >
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Learn how to retrieve your secret and publishable keys for payment automation with AutomateHQ.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-700 mb-6">
            Now that you have your Stripe API keys, you can use them in AutomateHQ to:
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Accept Payments</h4>
              <p className="text-gray-600 text-sm">Process one-time and recurring payments</p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Issue Refunds</h4>
              <p className="text-gray-600 text-sm">Automate refunds and cancellations</p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Subscription Management</h4>
              <p className="text-gray-600 text-sm">Manage customer subscriptions</p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h4 className="font-semibold text-gray-800 mb-2">Payment Notifications</h4>
              <p className="text-gray-600 text-sm">Send payment receipts and alerts</p>
            </div>
          </div>
        </motion.div>
      </div>
...
export default BlogPostStripeAPI; 